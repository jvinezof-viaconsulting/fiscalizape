					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="inforight" id="editarperfil">
								...
								<form class="needs-validation" novalidate method="post" action="../controller/perfilAterarSenha.php">
									<div class="mb-3">
										<label for="senha">Senha atual</label>
										<input type="password" name="senhaAtual" class="form-control" id="senha" placeholder="Senha atual..." required>
									...
									<div class="row">
										<div class="col-md-6 mb-3">
											...
											<input type="password" name="novaSenha" class="form-control" id="novasenha" placeholder="Nova senha..." required minlength="6" maxlength="30">
											<div class="invalid-feedback">
										...
										<div class="col-md-6 mb-3">
											...
											<input type="password" name="novaSenhaRepita" class="form-control" id="novasenhaRepita" placeholder="Nova senha..." required minlength="6" maxlength="30">
											<div class="invalid-feedback">
